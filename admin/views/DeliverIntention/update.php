<div class="box">
    ...
    <div class="box-detail">
            ...
            <div style="display:block;" class="box-detail-tab-item">
                ...
                <table>
                    <tr>
                        ...
                        <td width="10%"><?php echo $form->labelEx($model, 'phone'); ?></td>
                        <td width="10%">
        ...
        <div class="box-detail-submit"><button onclick="submitType='baocun'" class="btn btn-blue" type="submit">添加</button><button class="btn" type="button" onclick="we.back();">取消</button></div>
